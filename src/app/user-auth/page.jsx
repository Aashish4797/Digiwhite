  ...
  return (
    <div className="flex min-h-screen bg-gradient-to-r from-blue-100 to-purple-200 dark:from-gray-900 dark:to-gray-800">
      ...
      <div className="hidden w-1/2 bg-gray-100 lg:block">
        <Image
          src="/images/meet_image.jpg" //always use images from public folder
          width={1080}
          height={1080}
          alt="login_image"
      ...
      <div className="flex flex-col justify-center w-full p-8 lg:w-1/2">
        <div className="max-w-md mx-auto">
          ...
          <p className="mb-8 text-gray-600 dark:text-gray-100">
            "Seamlessly connect with your team anytime, anywhere. Host or join
            meetings with HD video and crystal-clear audio."
          </p>
          ...
          <div className="flex flex-col space-y-4 mt-6">
             ...
             <Button className="w-full bg-black text-white dark:hover:bg-gray-200 dark:bg-white dark:text-black" variant="ghost" onClick={() => handleLogin('github')}>
                <Github className="w-5 h-5 mr-2"/> Login with Github
             </Button>
