...
const VideoMeeting = () => {
  ...
  const [isJoining, setIsJoining] = useState(false); // guard flag
  ...
  }, [session, status, hasJoined, isJoining]);
  ...
  const joinMeeting = async (element) => {
    ...
    if (!appID || !serverSecret) {
      ...
      toast.error("Zego configuration error.");
      setIsJoining(false);
      return;
    }
          ...
          <div className="grid grid-col-1 md:grid-cols-3 gap-6 p-6 bg-gray-200 dark:bg-gray-800">
            <div className="text-center ">
              ...
              <p className="text-gray-600 dark:text-gray-300">
                Experience crystal-clear video with our high-definition video quality.
              </p>
            </div>
            <div className="text-center ">
              <Image
              ...
              <p className="text-gray-600 dark:text-gray-300">
                Easily share your screen with others to collaborate and present.
              </p>
            </div>
            <div className="text-center ">
              <Image
              ...
              <p className="text-gray-600 dark:text-gray-300">
                Your meetings are secure with end-to-end encryption and password protection.
              </p>
            </div>
          </div>
        </div>
